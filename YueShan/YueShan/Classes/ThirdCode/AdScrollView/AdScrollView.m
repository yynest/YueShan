...
- (void)setImageNameUrlArray:(NSArray *)imageNameUrlArray
{
    ...
    [_leftImageView sd_setImageWithURL:url placeholderImage:IMAGE_DEFAULT];
    url = [NSURL URLWithString:_imageNameUrlArray[1]];
    [_centerImageView sd_setImageWithURL:url placeholderImage:IMAGE_DEFAULT];
    url = [NSURL URLWithString:_imageNameUrlArray[2]];
    [_rightImageView sd_setImageWithURL:url placeholderImage:IMAGE_DEFAULT];
}
